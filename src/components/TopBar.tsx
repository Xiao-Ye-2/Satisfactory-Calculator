...
export const TopBar: React.FC = () => {
    ...
    useEffect(() => {
        const handleClickOutside = (event: MouseEvent) => {
            if (pageOptionsRef.current && !pageOptionsRef.current.contains(event.target as Node)) {
        ...
        <div className="flex items-center justify-between p-4 bg-gray-800 text-white relative">
            ...
            <div className="relative">
                ...
                {isLanguageOptionsVisible && (
                    ...
                    >
                        <ul className="p-2">
                            <li onClick={() => handleLanguageChange('en')} className="hover:bg-gray-300 p-2 cursor-pointer rounded-md text-center">English</li>
                            <li onClick={() => handleLanguageChange('zh-cn')} className="hover:bg-gray-300 p-2 cursor-pointer rounded-md text-center">简体中文</li>
